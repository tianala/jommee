    ...
    <footer class="bg-white border-t border-gray-100 mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 py-12">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2">
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">All Products</a></li>
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">New Arrivals</a></li>
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">Best Sellers</a></li>
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">Special Offers</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2">
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">Contact Us</a></li>
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">FAQs</a></li>
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">Shipping Policy</a></li>
                        <li><a href="#" class="text-gray-500 hover:text-[#fc8eac] text-sm transition">Returns & Exchanges</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <form class="mt-4 flex">
                        <input type="email" placeholder="Your email" class="px-4 py-2 w-full border border-gray-300 rounded-l-lg focus:outline-none focus:ring-1 focus:ring-[#fc8eac] focus:border-[#fc8eac] text-sm">
                        <button type="submit" class="bg-[#fc8eac] hover:bg-[#e47a98] text-white px-4 py-2 rounded-r-lg transition text-sm">
                            Join
                        </button>
                    </form>
                </div>
            ...
            <div class="border-t border-gray-100 py-6 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500 text-sm">
                    &copy; <script>document.write(new Date().getFullYear())</script> Jommee. All rights reserved.
                </p>
