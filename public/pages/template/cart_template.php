        ...
        >
                                ...
                                <div class="col-span-12 md:col-span-5 flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0">
                                    <div class="flex items-center w-full md:w-auto">
                                        ...
                                        <?php else: ?>
                                            <div class="w-16 h-16 md:w-20 md:h-20 bg-gray-200 flex items-center justify-center mr-4">
                                                <span class="text-gray-500 text-xs">No image</span>
                                            </div>
                                        <?php endif; ?>
                                        <div class="flex-1 md:flex-none">
                                            <h3 class="font-medium text-sm md:text-base"><?= htmlspecialchars($item['name']) ?></h3>
                                            <!-- Mobile Price -->
                                ...
                                <div class="hidden md:block col-span-2 text-center item-price" data-price="<?= $item['price'] ?>">
                                    ₱<?= number_format($item['price'], 2) ?>
                                </div>
                                ...
                                <div class="col-span-6 md:col-span-1 mt-2 md:mt-0 flex justify-end md:justify-center">
                                    <form method="POST">
                                        <input type="hidden" name="idcart" value="<?= $item['idcart'] ?>">
                                        <button type="submit" name="remove_item" class="text-red-500 hover:text-red-700 text-sm md:text-base">
                ...
                <div class="col-span-1">
                    <div class="bg-white rounded-lg shadow-md p-4 md:p-6 sticky top-4">
                        ...
                        <button class="w-full bg-[#fc8eac] hover:bg-[#e75480] text-white py-2 md:py-3 rounded-lg transition font-medium text-sm md:text-base">
                            Proceed to Checkout
                        </button>
