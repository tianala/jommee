        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit <?= htmlspecialchars($productName) ?></span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="space-y-6">
        <div class="relative">
            <div class="relative overflow-hidden rounded-lg">
                ...
                <button type="button" id="prevBtn" class="absolute left-2 top-1/2 -translate-y-1/2 bg-black/30 text-white rounded-full p-2 hover:bg-black/50 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button type="button" id="nextBtn" class="absolute right-2 top-1/2 -translate-y-1/2 bg-black/30 text-white rounded-full p-2 hover:bg-black/50 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function displayProductForm($product, $errors) {
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-row gap-3 pt-4">
            <button type="submit" class="flex-1 bg-[#fc8eac] text-white px-4 py-3 rounded-lg hover:bg-[#e47a98] font-medium text-sm sm:text-base sm:px-6">
                Save Changes
            </button>
            <a href="product_view.php?id=<?= $product['idproduct'] ?>" class="flex-1 text-center border border-[#fc8eac] text-[#fc8eac] px-4 py-3 rounded-lg hover:bg-[#fc8eac] hover:text-white font-medium text-sm sm:text-base sm:px-6">
                Cancel
            </a>
        </div>
    </div>
