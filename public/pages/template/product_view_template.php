    ...
    <div class="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="inline-flex items-center">
                    <a href="products.php" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-[#fc8eac]">
                        Products
                    </a>
                </li>
        ...
        <div class="grid md:grid-cols-2 gap-8 bg-white p-6 rounded-lg shadow-md relative">
            ...
            <div class="absolute top-4 right-4 z-10">
                <div class="relative inline-block text-left">
                    <button id="dropdownButton" class="p-2 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#fc8eac]">
                    ...
                    <div id="dropdownMenu" class="dropdown-menu">
                        <div class="py-1" role="none">
                            <a href="edit_product.php?id=<?= $id ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Edit Product</a>
                            <button onclick="confirmDelete()" class="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-gray-100 hover:text-red-900" role="menuitem">Delete Product</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative overflow-hidden rounded-lg">
                    ...
                    <button id="prevBtn" class="absolute left-2 top-1/2 -translate-y-1/2 bg-black/30 text-white rounded-full p-2 hover:bg-black/50 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>
                    </button>
                    <button id="nextBtn" class="absolute right-2 top-1/2 -translate-y-1/2 bg-black/30 text-white rounded-full p-2 hover:bg-black/50 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="absolute bottom-4 left-0 right-0 flex justify-center gap-2">
                        <?php foreach ($all_images as $index => $image): ?>
                        <button class="carousel-indicator w-2 h-2 rounded-full bg-white/50 hover:bg-white/80 transition <?= $index === 0 ? 'bg-white/80' : '' ?>" 
         ...
         onclick="goToSlide(<?= $index ?>)">
            ...
            <div class="space-y-4">
                ...
                <div class="mt-4">
                    ...
                    <div class="text-sm text-gray-400 line-through">₱<?= number_format($product['price'] * 1.3, 2) ?></div>
                ...
                <div class="py-4">
                    ...
                    <div class="flex items-center">
                        <button type="button" onclick="decreaseQuantity()" class="bg-gray-200 px-3 py-1 rounded-l-lg hover:bg-gray-300 transition">-</button>
                        ...
                        <button type="button" onclick="increaseQuantity()" class="bg-gray-200 px-3 py-1 rounded-r-lg hover:bg-gray-300 transition">+</button>
